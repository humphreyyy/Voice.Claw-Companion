...
Build or download `voiceclaw-companion_0.1.3_amd64.deb`, then install it:

```sh
sudo dpkg -i voiceclaw-companion_0.1.3_amd64.deb
```
...
../scripts/verify_linux_companion.sh \
  dist/voiceclaw-companion_0.1.3_amd64.deb
```
