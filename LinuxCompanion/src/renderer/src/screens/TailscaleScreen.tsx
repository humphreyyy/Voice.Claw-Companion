...
export function TailscaleScreen({
  ...
  return (
    <section className="screen panel parity-panel">
      ...
      <div className="info-card"><strong>Why the URL has a port</strong><span>The port selects the VoiceClaw Realtime bridge service on this Linux host. A path mapping such as /voice can reach ordinary bridge endpoints, but the iPhone WebRTC signaling contract requires its own HTTPS origin or port. If you change the bridge port, run Install and Start again and pair the phone with the new QR code.</span></div>
